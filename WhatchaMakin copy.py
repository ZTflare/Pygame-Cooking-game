...
test_font2 = pygame.font.Font(None ,70)
...
async def main():
    ...
    if keys [pygame.K_e]: #PLAYER 1 INTERACTION KEY
        ...
        #Chopped Beef holder
        if Player1_mask.overlap(ChoppedBeeftable_mask, (ChoppedBeeftable_rect.x - Player1_rect.x, ChoppedBeeftable_rect.y- Player1_rect.y)):
